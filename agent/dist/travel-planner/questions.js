import { hasBudgetOrComfort, hasOriginOrUndecided, hasTravelers, } from "./stage.js";
function buildIntentQuestions(state) {
    const questions = [];
...
function buildRegionQuestions(state) {
    const questions = [];
...
function buildDateQuestions(state) {
    const questions = [];
...
function buildWeightQuestions(state) {
    const questions = [];
...
export function generateQuestions(stage, state, maxCount = 3, options) {
    let candidates = [];

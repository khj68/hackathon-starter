...
async function callCallback(status, sessionId, errorMessage) {
...
function readLastEntry(sessionFilePath) {
...
function appendSessionEntries(workspace, sessionId, userText, responseText) {

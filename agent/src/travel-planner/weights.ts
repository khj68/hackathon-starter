import { PlannerState, WeightKey } from "./schema.js";
...
function addRationale(state: PlannerState, key: WeightKey, reason: string): void {
...
function parsePurposeTags(text: string): string[] {
